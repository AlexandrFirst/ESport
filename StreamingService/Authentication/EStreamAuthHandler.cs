...
namespace StreamingService.Authentication
{
    public class EStreamAuthHandler : AuthenticationHandler<EStreamAuthOptions>
    {
        public EStreamAuthHandler(IOptionsMonitor<EStreamAuthOptions> options, 
