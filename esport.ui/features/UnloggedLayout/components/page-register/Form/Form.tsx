...
export const Form: React.FC<FormProps> = ({ methods, currStep, setCurrStep }) => {
  ...
  return (
    <SportForm methods={methods} className={cn('text-center overflow-hidden', styles.form, { ['w-full']: isMobile, ['w-80']: !isMobile })}>
      ...
      <Grid container justifyContent='space-between'>
        ...
        {!isLastStep ? (
          ...
          <SportButton className='w-60 my-3' onClick={handleSubmit(registration)}>
            Submit
          </SportButton>
        )}
      </Grid>
      Already have an account? <SportLink to={routes.Login}>Sign in instead</SportLink>
