...
export const { actions: CurrentUserProfileInfoActions } = CurrentUserProfileInfoSlice;
export const { reducer: CurrentUserProfileInfoReducer } = CurrentUserProfileInfoSlice;
